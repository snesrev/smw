  ...
  if ((misc_level_layout_flags & (uint8)(misc_scratch7e185e + 1)) != 0) {
    ...
    if ((ypos >> 8) < misc_screens_in_lvl) {
      ...
      if ((pt_out->x >> 8) < 2) {
        ...
        if (misc_scratch7e185e) {
          v4 = kLevelDataLayoutTables_EightBitLo_Vertical_L2[r13];
          v5 = kLevelDataLayoutTables_EightBitHi_Vertical_L2[r13];
        }
...
LABEL_9:
  ...
  uint16 v10 = PAIR16(kLevelDataLayoutTables_EightBitHi[xx], kLevelDataLayoutTables_EightBitLo[xx]);
  if (misc_scratch7e185e) {
    v10 = PAIR16(kLevelDataLayoutTables_EightBitHi_Horizontal_L2[xx], kLevelDataLayoutTables_EightBitLo_Horizontal_L2[xx]);
  }
...
uint8 SprXXX_LineGuided_01D94D(uint16 r0w, uint16 r2w) {  // 01d94d
  ...
  if ((misc_level_layout_flags & 1) != 0) {
    ...
    r5 = PAIR16(kLevelDataLayoutTables_EightBitHi[r2w >> 8], kLevelDataLayoutTables_EightBitLo[r2w >> 8]) + PAIR16(r0w >> 8, v3);
  }
  blocks_currently_processed_map16_tile_lo = g_ram[r5];
...
void Spr082_BonusGame_01DFD9() {  // 01dfd9
  ...
  do {
    for (uint8 i = 2; (i & 0x80) == 0; --i) {
      ...
      uint8 r2 = kSpr082_BonusGame_Init_DATA_01DD99[v1 + 1];
      uint8 r3 = kSpr082_BonusGame_Init_DATA_01DD90[v1 + 1];
      uint8 j;
      for (j = 9; j != 1; --j) {
